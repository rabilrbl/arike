...
class Reports(BaseModel):
    ...
    last_sent = models.DateTimeField(blank=True, null=True, default=datetime(datetime.today().year, datetime.today().month, datetime.today().day), help_text="Choose time")
