...
class VisitAgendaView(PermissionRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        return render(request, 'Nurse/agenda_visit.html', {'pk': kwargs['pk'], 'patient_id': kwargs['patient_id']})
...
class TreatmentNoteView(PermissionRequiredMixin, CreateView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['treatment'].queryset = Treatment.objects.filter(patient=self.kwargs['patient_id'])
        return form
