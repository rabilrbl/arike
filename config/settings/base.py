...
MIGRATION_MODULES = {"sites": "arike.contrib.sites.migrations"}
...
ADMINS = [("""Mohammed Rabil""", "rabil@email.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "arike API",
    "DESCRIPTION": "Documentation of API endpoints of arike",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
    "SERVERS": [
        {"url": "http://127.0.0.1:8000", "description": "Local Development server"},
        {"url": "https://arikecare.herokuapp.com", "description": "Production server"},
    ],
}
# Your stuff...
# ------------------------------------------------------------------------------
